...
public class UsuariosDAO {
    ...
    public void salvarUsuario(Usuarios usuario,String nome, String how, JFrame jfUsuario) {
    ...
    //ALTERAR
    public void alterarUsuario(Usuarios usuario,String nome, String how, JFrame jfUsuario) {
         try {
             con = Conexoes.conectar();
    ...
    //APAGAR
    public void apagarUsuario(Usuarios usuario,String nome, String how, JFrame jfUsuario) {
    ...
    public void consultarUsuarioNotificacao(String nome,JTextArea txt_notificacao_home,JFrame jfUsuario) {
     ...
     public void alterarUsuarioNotificacao(Usuarios usuario, JFrame jfUsuario) {
         try {
            con = Conexoes.conectar();
