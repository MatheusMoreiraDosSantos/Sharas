<<<<<<< HEAD:Sistema SharasV.2_construindo/src/controller/Telas.java
/*
...
public class Telas {
     ...
     *
     * @param aberta pega a tela que está aberta
     * @param tela o numero da tela que vai aparecer 1 para tela prncipal(home)
     * 2 Cadastro de cliente 3 Vendas/serviços/contrato 4 calendario 5 animais 6
     * pastagem 7 Celeiro //Telas especiais 8 ferrejeamento 9 veterinario //Tela
     * de alto nivel 10 financeiro 11 cadastrar funcionario 12 Usuarios 13log
     */
    public void alterar(JFrame aberta, int tela) {
        JFrame n_tela = null;
        //pega como parametro o nome da tela que vai abrir 
        switch (tela) {
            case 1:
                n_tela = new JF_Principal1();
                break;
            case 2:
                n_tela = new JF_Cliente();
                break;
            case 3:
                n_tela = new JF_Contrato();
                break;
            case 4:
                n_tela = new JF_calendario();
                break;
            case 5:
                n_tela = new JF_animais();
                break;
            case 7:
                n_tela = new JF_Celeiro();
                break;
            case 11:
                n_tela = new JF_funcionarios();
                break;
            case 12:
                n_tela = new JF_Ususario();
                break;
            case 13:
                n_tela = new JF_Log();
                break;
            ...
            default:
                JOptionPane.showMessageDialog(aberta, "tela não encontrada");
        }
        if (n_tela != null) {
            n_tela.setVisible(true);
            aberta.dispose();
...
>>>>>>> master:Sistema SharasV.2_construindo/src/funcoes/Telas.java
